...
const CTA = () => {
  return (
    ...
    <svg 
    className='w-full h-auto h-max-40 translate-y-[1px]'
...
<section className='relative bg-dark-hard px-5'>
  <div className='container grid grid-cols-12 mx-auto py-10 md:pb-10 lg:place-items-center'>
    <div className='col-span-12 lg:col-span-6'>
      ...
      <div className='w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0'>
        <input type="text" className='rounded-lg placeholder:text-dark-light px-4 py-3 w-full ' placeholder='Your Email' />
        <button className='px-4 py-3 font-bold bg-primary text-white rounded-lg w-full md:w-fit md:whitespace-nowrap'>Get started</button>
      </div>
      <p className='text-dark-light text-sm
                    leading-7 mt-6 md:text-center md:text-base'>
        <span className='italic font-bold
                         text-[#B38ACS] md:non-italic md:font-normal md:text-dark-light'>Get a response tomorrow </span> 
 ...
 <div className='w-3/4 mx-auto relative'>
  ...
  <div className='w-1/2 h-1/2 rounded-lg bg-[#FC5A5A] absolute top-[10%] -right-[8%]'></div>
  <div className='w-1/2 h-1/2 rounded-lg bg-white opacity-[0.08] absolute bottom-[10%] -left-[8%]'></div>
 ...
 <div className='rounded-xl w-full bg-white p-3 z-[1] relative '>
   ...
   <div className='p-5'>
       <h2 className='font-roboto font-bold text-xl text-dark-soft md:text-3xl'>Future of Work</h2>
